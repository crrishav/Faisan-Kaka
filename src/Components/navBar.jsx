                      ...
                      return (
                        <div key={i.id} className="flex items-center justify-between w-full">
                          <div className="flex items-center gap-3">
                            ...
                            <div className="flex flex-col">
                              <span className="text-sm font-bold text-black leading-snug">{i.title}</span>
                              {i.size && (
                                <span className="text-[10px] text-black/50 font-semibold leading-tight">Size: {i.size}</span>
                              )}
                              {i.customDetails?.description && (
                                <span className="text-[10px] text-black/60 italic leading-tight truncate max-w-[150px]" title={i.customDetails.description}>
                                  Note: "{i.customDetails.description}"
                                </span>
                              )}
                              <span className="text-xs text-black/70 mt-0.5">
          ...
          <div className="border-t border-black/10 bg-white/90 backdrop-blur-md">
            ...
            <div>
              ...
              <div
                ...
                className={`overflow-hidden transition-all duration-300 ease-in-out ${mobileSubmenu === 'collection' ? 'max-h-64 opacity-100' : 'max-h-0 opacity-0'
                  }`}
              >
            ...
            <div className="border-t border-black/5">
              ...
              <div
                ...
                className={`overflow-hidden transition-all duration-300 ease-in-out ${mobileSubmenu === 'about' ? 'max-h-[480px] opacity-100' : 'max-h-0 opacity-0'
                  }`}
              >
            ...
            <div className="border-t border-black/5">
              ...
              <div
                ...
                className={`overflow-hidden transition-all duration-300 ease-in-out ${mobileSubmenu === 'search' ? 'max-h-80 opacity-100' : 'max-h-0 opacity-0'
                  }`}
              >
                        ...
                        <div key={i.id} className="flex items-center justify-between w-full">
                          <div className="flex items-center gap-3">
                            ...
                            <div className="flex flex-col">
                              ...
                              {i.customDetails?.description && (
                                <span className="text-[10px] text-black/60 italic leading-tight truncate max-w-[120px]" title={i.customDetails.description}>
                                  Note: "{i.customDetails.description}"
                                </span>
                              )}
                              <span className="text-xs text-black/70 mt-0.5">
